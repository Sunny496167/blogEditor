      ...
      <nav className="bg-white border-gray-200 px-4 lg:px-6 py-2.5">
        <div className="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
          ...
          <div className="flex items-center lg:order-2">
            <Link
              to="#"
              className="text-white bg-pink-500 h-16 w-16 hover:bg-orange-800 focus:ring-4 focus:ring-orange-300 font-medium rounded-3xl text-sm px-4 lg:px-5 py-2 lg:py-2.5 mr-5 focus:outline-none"
            >
              P 
            </Link>
          </div>
